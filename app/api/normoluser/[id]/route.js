...
export async function POST(req) {
    const { name, email, message } = await req.json(); // Include message
    console.log(name, email, message); // Log the message for debugging
        ...
        <body>
          <div class="container">
           <div class="logo">
            ...
            <p>Dear ${name},</p>
            <p>Message from the website: ${message}</p> <!-- Include the message here -->
          </div>
        </body>
        </html>
    `;
